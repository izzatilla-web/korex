      ...
      <Wrapper className="relative">
        <div className="flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
          <div className="max-w-[680px]">
            ...
            <p className="mt-4 max-w-[560px] text-[15px] leading-7 text-[#677895] sm:text-[16px]">
        ...
        <div
          ref={railRef}
          className="mt-8 flex snap-x snap-mandatory gap-4 overflow-x-auto pb-4 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden lg:mt-12"
        >
          {stockCars.map((car) => (
